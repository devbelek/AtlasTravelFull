...
//   const updateLanguageIfNecessary = (savedLanguage: string | null) => {
//     const language = languages.find((lang) => lang.key === savedLanguage) || languages[0];

//     if (!currentLanguage || currentLanguage.key !== language.key) {
//       setCurrentLanguage(language);
//     }
//   };
...
//       // Если языка нет в localStorage, установить "ru" по умолчанию
//       if (!savedLanguage) {
//         localStorage.setItem("currentLanguage", "ru");
//         updateLanguageIfNecessary("ru");
//       } else {
//         updateLanguageIfNecessary(savedLanguage);
//       }

//       const currentPath = window.location.pathname;
//       const isLanguageInPath = languages.some((lang) =>
//         currentPath.startsWith(`/${lang.key}`)
//       );

//       if (!isLanguageInPath) {
//         window.history.replaceState(null, "", `/ru${currentPath}`);
//       }
//     } else {
//       updateLanguageIfNecessary("ru");
...
//       if (!newPathname.startsWith(`/${key}`)) {
//         window.history.replaceState(null, "", `/${key}${currentPath}`);
//       } else {
